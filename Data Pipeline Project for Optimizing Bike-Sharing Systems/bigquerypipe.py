...
#             for city in country['cities']:
#                 for station in city['places']:
#                     for bike in station.get('bike_list', []):
#                         row = {
#                             'vendor_latitude': country.get('lat'),
#                             'vendor_longitude': country.get('lng'),
#                             'vendor_name': country.get('name'),
...
#                         count += 1
#                         if count % 1000 == 0:
#                             insert_rows(bigquery_client, table_ref, rows)
#                             rows = []
...
# def insert_rows(bigquery_client, table_ref, rows):
#     errors = bigquery_client.insert_rows_json(table_ref, rows)  # API request
#     if errors:
